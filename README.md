...
(bootloader) battery-voltage:3966
...
(bootloader) partition-type:quantumcontentfv:raw
(bootloader) partition-size:quantumcontentfv: 0x100000
...
(bootloader) partition-size:pvmfw_b: 0x200000
...
(bootloader) partition-size:keymaster_b: 0xA00000
...
(bootloader) partition-size:bluetooth_b: 0x500000
(bootloader) partition-type:modem_b:raw
(bootloader) partition-size:modem_b: 0x16800000
...
(bootloader) partition-size:pvmfw_a: 0x200000
...
(bootloader) partition-size:keymaster_a: 0xA00000
...
(bootloader) partition-size:bluetooth_a: 0x500000
(bootloader) partition-type:modem_a:raw
(bootloader) partition-size:modem_a: 0x16800000
...
(bootloader) partition-size:userdata: 0x19B05D3000
...
(bootloader) partition-size:oem: 0x4000000
